...
<div class="card h-100">
  ...
  <div class="card-body">
    ...
    <p class="text-body-secondary mb-2">Drop-in tutoring and study
      support.</p>
  ...
  <div class="card-footer d-flex gap-2">
    <button class="btn btn-outline-secondary" type="button">Copy
      email</button>
    <button class="btn btn-outline-primary" type="button">Open
      map</button>
  </div>
</div>
