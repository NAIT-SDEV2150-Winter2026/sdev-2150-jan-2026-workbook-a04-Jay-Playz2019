  ...
  <div class="card-body">
    <form id="frm-filter">
      ...
      <div class="d-flex flex-wrap gap-2"
        ...
        <button class="btn btn-sm btn-outline-primary"
        type="button">Wellness</button>
        <button class="btn btn-sm btn-outline-primary"
        type="button">Financial</button>
        <button class="btn btn-sm btn-outline-primary"
        type="button">Tech</button>
        </div>
      <hr class="my-3" />
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value
          id="virtual" />
        <label class="form-check-label" for="virtual">Virtual
          options</label>
      </div>
...
customElements.define('resource-filter', ResourceFilter)