...
<div class="card h-100">
  ...
  <div class="list-group list-group-flush">
    <button type="button"
      ...
      <p class="mb-1 small text-body-secondary">Drop-in tutoring and
        study support.</p>
    ...
    <button type="button"
      ...
      <p class="mb-1 small text-body-secondary">Confidential mental
        health supports.</p>
    ...
    <button type="button"
      ...
      <p class="mb-1 small text-body-secondary">Funding options and
        application help.</p>
      <small class="text-body-secondary">Student Services, Main Floor
        CAT</small>
    </button>
    ...
    <button type="button"
      ...
      <p class="mb-1 small text-body-secondary">Account access, Wi-Fi,
        BYOD support.</p>
